...
const ListItem = React.forwardRef((props, ref) => {
  ...
  const { icon: ctxIcon, spacing, center, listStyleType, size, withPadding } = List_context.useListContext();
  const { classNames, styles: styles$1, unstyled } = styles.useContextStylesApi();
  const _icon = icon || ctxIcon;
  const { classes, cx } = ListItem_styles['default']({ withPadding, size, listStyleType, center, spacing }, { classNames, styles: styles$1, unstyled, name: "List" });
